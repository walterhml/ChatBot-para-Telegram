...
CHAVE_API = "7130516546:AAFyNw-P5250L6hhhx4yyOwHzH-2Er8eYc0-8976868"
...
def opcao3(mensagem):
    bot.send_message(mensagem.chat.id, "Valeu! Walter mandou um abraço de volta")
...
def responder(mensagem):
    ...
    Escolha uma opção para continuar (Clique no item):
     ...
     /opcao3 Mandar um abraço pro Walter
